...
import com.example.bookshelfappkotlin.databinding.RowCommentBinding
...
class AdapterComment: RecyclerView.Adapter<AdapterComment.HolderComment> {
    ...
    //viewbinding row_comment.xml =>RowCommentBinding
    ...
    override fun onBindViewHolder(holder: HolderComment, position: Int) {
        ...
        //we don't have user name or profile pic, we will use user uid to load
            ...
            .addListenerForSingleValueEvent(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    try {
                        ...
                        //in case of exception due to empty image, null, etc: set default image
