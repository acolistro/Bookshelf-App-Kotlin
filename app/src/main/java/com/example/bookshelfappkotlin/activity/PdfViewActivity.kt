...
import com.example.bookshelfappkotlin.Constants.MAX_BYTES_PDF
import com.example.bookshelfappkotlin.databinding.ActivityPdfViewBinding
...
class PdfViewActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //get book id from intent, it will be used to load a book from firebase
            ...
            .addOnSuccessListener { bytes ->
                ...
                binding.pdfView.fromBytes(bytes)
                    ...
                    .onPageChange{page, pageCount ->
                        ...
                        val currentPage = page + 1 //page starts from 0
                        binding.toolbarSubtitleTv.text = "${currentPage}/${pageCount}" //e.g. 3/325
